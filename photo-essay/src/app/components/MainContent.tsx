    ...
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <div className="mt-10 text-xl leading-8 text-justify text-black">
          ...
          <p className="mt-8 text-xl leading-8 text-justify text-black">
          After the wedding, they returned to Mexico City and started a family. They had four children, three sons and a daughter, each with a family. Eventually, Emilia and Norberto became grandparents of seven grandchildren.
          </p>
        </div>
      ...
      {/* His Legacy */}
        ...
        <div className="mt-10 text-xl leading-8 text-justify text-black">
          ...
          <p className="mt-8 text-xl leading-8 text-justify text-black">
            Those who love us never truly leave us when they pass away. My life and those of my cousins will always be intertwined with Norberto’s and Emilia’s: they were the runners before us, giving us a home, family, education, and other privileges as their baton. Our accomplishments are built upon the crises they endured and the race they covered, together and on their own. I see them in the college I have the privilege to attend, the opportunities I have been offered, and the challenges we are forced to face in our quest for a better quality of life. As my grandfather’s story ended, my cousins and I continued his legacy, hoping we would pass on a baton of equal worth, full of love, family, and possibilities.
          </p>
        </div>
      </div>
    </div>
